...
export default function App() {
  return (
    <footer className="bg-neutral-100 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left mt-4">
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="">
            ...
            <p className="mb-4">
              <a className="text-neutral-600 dark:text-neutral-200">Videos</a>
            </p>
            <p>
              <a className="text-neutral-600 dark:text-neutral-200">
                Our Homes
