...
import "./Gallery.css";
import image1 from "../Assests/img_6.jpg";
import image2 from "../Assests/img_6.jpg";
import image3 from "../Assests/img_6.jpg";
  ...
  return (
    <div className="gallery">
      ...
      <div className="about">
        ...
        <h3>About</h3>
        <p>
          Hikkaduwa is a small town on the south coast of Sri Lanka. It is known
          for its strong surf and beaches, and is a popular destination for
